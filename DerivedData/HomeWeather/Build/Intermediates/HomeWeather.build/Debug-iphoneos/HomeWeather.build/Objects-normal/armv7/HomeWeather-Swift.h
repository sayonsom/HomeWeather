...
SWIFT_CLASS("_TtC11HomeWeather11AppDelegate")
...
SWIFT_CLASS("_TtC11HomeWeather14ViewController")
@interface ViewController : UIViewController <PNObjectEventListener>
@property (nonatomic, strong) PubNub * _Null_unspecified client;
@property (nonatomic, readonly, strong) PNConfiguration * _Nonnull configuration;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified humidity;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified livingRoomTemp;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified pullmanOutside;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified pullmanFeelsLike;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified pullmanForecast;
- (void)viewDidLoad;
- (void)updateLabel;
- (void)client:(PubNub * _Nonnull)client didReceiveMessage:(PNMessageResult * _Nonnull)message;
